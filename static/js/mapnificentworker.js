...
var mapnificentWorker = (function (undefined) {
  ...
  var calculateTimes = function (
    ...
    while (nsl > 0) {
      // as long as we have next stations to go
      for (i = 0; i < nsl; i += 1) {
        count += 1;
        ...
        */
        if (
          line !== -1 &&
          stationMap[stationId] !== undefined &&
          ...
          for (j = 0; j < travelOptionLength; j += 1) {
            ...
            if (rStation.Stop != fromStation && rStation.Line === line) {
              ...
              if (
                stationMap[rStation.Stop] === undefined ||
        ...
        for (j = 0; j < travelOptionLength; j += 1) {
          ...
          if (rStation.WalkDistance !== undefined) {
            // Walking
